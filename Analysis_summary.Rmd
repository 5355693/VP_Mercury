...
Performing a t-test assuming unequal variances, we find that the 95% credible interval for the difference in methylmercury (the parameter named "delta") between the two habitats includes zero (-0.00015, 0.00132).
```{r, echo = FALSE}
library(R2jags)
library(mcmcplots)
...
Repeating the analysis using total mercury levels in water produces a similar result: the difference in total mercury between coniferous and deciduous pools is approximately zero (mean difference = 0.00026, 95% credible interval = -0.00053 - 0.00108).
```{r, echo = FALSE}
