...
Performing a t-test assuming unequal variances, we find that the 95% credible interval for the difference in methylmercury (the parameter named "delta") between the two habitats includes zero (0.000, 0.00146).
```{r, echo = FALSE}
library(R2jags)
library(mcmcplots)
...
Repeating the analysis using total mercury levels in water produces a similar result: the difference in total mercury between coniferous and deciduous pools is small, with a weak tendency fo rhigher mercury in coniferous pools (mean difference = 0.00072, 95% credible interval = -0.00002 - 0.00147).
```{r, echo = FALSE}
...
tissue or blood of larval amphibians.
